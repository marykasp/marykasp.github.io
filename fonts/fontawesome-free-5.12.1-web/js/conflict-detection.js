...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
      ...
      /**
       * Bi<i class="fab fa-twitter"></i>ise rotate a 32-bit number to the left.
       *
  ...
  function detec<i class="fab fa-twitter"></i>ebfontConflicts() {
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      diagFrame.onload = function () {
        diagFrame.conten<i class="fab fa-twitter"></i>indow.addEventListener('error', silenceErrors, true);
  ...
  function conflictDetection() {
    ...
    var cssToTest = detec<i class="fab fa-twitter"></i>ebfontConflicts();

    var nodesFound = _objectSpread({}, scriptsToTest, cssToTest);

    var testCount = Object.keys(scriptsToTest).length + Object.keys(cssToTest).length; // The resultsCollectionMaxWait allows for the time be<i class="fab fa-twitter"></i>een when the tests running under
    // child iframes call postMessage with their results, and when the parent window
    // receives and handles those events with window.onmessage.
    // Making it configurable allows us to test the scenario where this timeout is exceeded.
    // Naming it something very different from "timeout" is to help avoid the potential ambiguity be<i class="fab fa-twitter"></i>een
    // these <i class="fab fa-twitter"></i>o timeout-related settings.
